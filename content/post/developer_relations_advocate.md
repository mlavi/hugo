...
My third job out of college was a pay cut and a one-way ticket of 4000 KM or 2500 miles from my home, my Father was slightly unhappy with my decision, but my Mother was excited for me. In 1996, the move kick started my career in Silicon Valley, understanding start-ups and stock options, and the discovery of my wife to be!

As one of the webmasters of Netscape, the company that led the charge onto the world wide web via browsers and a suite of server products, I already had a pioneering role working on the world's highest visited web site. The web was fairly new and I was given title of Content Engineer reporting to [Hugh Duberly](http://www.dubberly.com/about), Creative Director, because the Netscape website was part of Electronic Marketing and it was considered a publishing platform for marketing programs. I had two peer engineers, [Jonathan Feinstein](https://www.linkedin.com/in/jonathan-feinstein-616597/) and [Alan Spar](https://www.linkedin.com/in/alan-spar-2622ba22/), who had preceded me, and I was always envious of Jonathan's SGI Indy workstation! Netscape's web site was in CVS, we requested Server Engineering "push" the web site at the end of every work day (by passing around red boxing gloves), which was rsync to the web server farm over a hacked in SSH transport. At Netscape, you could log-in to any internal workstation, because everyone NFS mounted /home.

Despite being content focused on HTML (the DOM and CSS happened later), my peers pushed the boundaries of the web with JavaScript whenever possible to make normally static web pages become interactive. Back then, viewing the source of a web page was the easiest manner to learn the tricks of the web because the front-end focus of web client development was fueled by intense Netscape, Microsoft, and Opera competition to innovate on the web experience. There was such intense interest in the web, when people asked me how hard it was to get started, I would often reply, "a webmaster is someone who is only six months ahead of you." I wanted to let people know it was easy to start and that learning would never end, these were values that innately resonated from my upbringing and education, and they were critical elements for my next role at Netscape.

> Server-side web scale work was even more of an infant and CGI was the first tool many learned, something I'd self-taught and combined with PERL 4.0.36 at my first post-graduate job. I wrote the Plug-in Finder (a PERL CGI) and worked with Server Engineering to insure it would perform under load while working with marketing to make a database management web app of plug-in providers.
...
I was part of the Netscape layoffs in 1998 of over 10% of the workforce, Netscape was a casualty of the "Browser Wars," and Microsoft would eventually be found guilty of anti-trust practices by the United States Department of Justice. The work achieved by Netscape and its partner ecosystem could not be undone and much of the Netscape's value in establishing the open web continues at Mozilla. Microsoft continues to erode it's proprietary hold on business and power open technologies to remain relevant in operating systems, tools, and clouds.

# The Continued Rise of the Developer

When my first DevRel career ended, a few key events drove mass awareness of my experience; they follow in the next sections.
...
With the creation of the term DevOps from the groundswell creation of the [Agile Infrastructure Google Group](https://groups.google.com/forum/#!forum/agile-system-administration), Patrick Dubois founded a community and a movement that sought to break down the traditional silos between application developers and infrastructure operators to deliver their work to customers.

This same year Nutanix was founded, pioneering the term Hyperconverged Infrastructure (HCI), which disrupts the entire infrastructure industry by combining the storage, virtualization, and network silos into a software defined cluster, delivering an Enterprise Cloud experience for Agile Infrastructure.
